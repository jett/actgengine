...
//            System.out.println("ref:" + clientChargedEvent.getReference() + "\t CR: " + glref.getUnitCode() +"\t" + glref.getBookCode() +  "\t" + glref.getCode() + "\t" + glref.getDescription() + "\t" + glref.getCurrency() + "\t" + clientChargedEvent.getAmount());
            ...
            // add the entry (if glCode is *, replace it with the events unit code
//            ledger.addEntry(clientChargedEvent.getReference(),  "C",
//                    glref.getUnitCode().equalsIgnoreCase("*") ? clientChargedEvent.getUnitCode():glref.getUnitCode(),
//                    glref.getBookCode(),
//                    glref.getCode(),
//                    glref.getDescription(),
//                    glref.getCurrency(),
//                    clientChargedEvent.getAmount(),
//                    clientChargedEvent.getDescription());
